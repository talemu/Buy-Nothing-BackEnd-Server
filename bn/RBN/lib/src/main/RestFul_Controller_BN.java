...
//From /Final Project CS445/src/main/webapp/wsdl/RestFul_Controller_BN.wsdl, caused errors, had to delete
...
//				a.setStreet(String.valueOf(jo.getJSONObject("address").get("street")));
	...
	@GET
	public Response getMyAsks(@PathParam("uid") UUID uid, @QueryParam ("is_active") @DefaultValue("???") boolean tf) {
